...
require_once __DIR__ . '/../infraestructura/repos/ProveedorRepository.php';
    ...
    switch ($method) {
        ...
        case 'POST':
            if (empty($input['documento']) || empty($input['nombre'])) {
                http_response_code(400); respond(['error' => 'documento y nombre requeridos'], $format); break;
            }
